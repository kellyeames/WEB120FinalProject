...
#EDIT THE FOLLOWING:
$toAddress = "k.leanne.e@gmail.com";  //place your/your client's email address here
$toName = "Kelly Eames"; //place your client's name here
$website = "kellyleanne.com/web120/streamline";  //place NAME of your client's website here
#--------------END CONFIG AREA ------------------------#
...
if ($response != null && $response->success)
    ...
    <div class="contact-feedback">
        ...
        <p>We'll respond via email within 48 hours, if you requested to be contacted.</p>
    </div>    
    <!-- END HTML FEEDBACK -->        
    <?php
